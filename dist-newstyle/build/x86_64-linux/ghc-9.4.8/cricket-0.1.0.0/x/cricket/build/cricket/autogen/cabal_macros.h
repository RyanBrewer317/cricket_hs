...
/* package cricket-0.1.0.0 */
#ifndef VERSION_cricket
#define VERSION_cricket "0.1.0.0"
#endif /* VERSION_cricket */
#ifndef MIN_VERSION_cricket
#define MIN_VERSION_cricket(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cricket */
...
#define CURRENT_COMPONENT_ID "cricket-0.1.0.0-inplace-cricket"
